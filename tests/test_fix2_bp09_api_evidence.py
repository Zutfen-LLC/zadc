"""FIX2-BP-09: Package/API and evidence accuracy.
...
remains bounded with no A2/A3/001B+ symbols.
"""
...
class TestPublicAPIBounded:
    """Public API remains bounded and no A2/A3/001B+ symbols are introduced."""
    ...
    PROHIBITED_SYMBOLS = {
        # A2/A3/001B+ functionality — must not exist
        "Packet",
        "CompletionReport",
